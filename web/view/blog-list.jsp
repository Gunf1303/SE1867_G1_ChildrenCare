...
<style>
        .cards img {
            ...
            object-fit: cover; /* Đảm bảo ảnh phủ kín mà không bị kéo dãn */
        }
    </style>
    </head>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 pb-2">
                        <div class="cards blog blog-primary border-0 shadow rounded overflow-hidden">
                            <img src="${l.getThumbnail()}" class="img-fluid" alt="">
                            <div class="card-body p-4">
                                <ul class="list-unstyled mb-2">
                                    <li class="list-inline-item text-muted small me-3"><i class="uil uil-calendar-alt text-dark h6 me-1"></i>${l.getCreatedDate()}</li>
<!--                                    <li class="list-inline-item text-muted small"><i class="uil uil-clock text-dark h6 me-1"></i>5 min read</li>-->
                                </ul>
                                <a href="/ChildrenCare/blogDetail?ID=${l.getPostID()}" class="text-dark title h5">${l.getTitle()}</a>
                                <p class="m-1">${l.getBriefInfo()}</p>
...
<!--                                    <ul class="list-unstyled mb-0">
                                    ...
                                    <a href="/ChildrenCare/blogDetail?ID=${l.getPostID()}" class="link">Read More <i class="mdi mdi-chevron-right align-middle"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
...
<div class="col-12">
    <ul class="pagination justify-content-center mb-0 list-unstyled">
        ...
        <!-- Hiển thị trang đầu tiên và 3 chấm nếu currentPage > 3 -->
        ...
        <!-- Lặp qua các trang xung quanh currentPage (hiển thị 3 trang) -->
        ...
        <!-- Hiển thị 3 chấm và trang cuối cùng nếu currentPage < numOfPage - 2 -->
