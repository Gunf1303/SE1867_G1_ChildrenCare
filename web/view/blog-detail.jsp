                    ...
                    <ul class="navigation-menu nav-left">
                        ...
                        <li class="has-submenu parent-parent-menu-item"><a href="javascript:void(0)">Pages</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                ...
                                <li class="has-submenu parent-menu-item">
                                    <a href="/ChildrenCare/blog" class="sub-menu-item">Blogs</a></li>
                        </li>
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <h3 class="sub-title mb-4">${title}</h3>
                            <p class="para-desc mx-auto text-muted">${categoryOfPost}</p>

                            <ul class="list-unstyled mt-4">
                                <li class="list-inline-item user text-muted me-2"><i class="mdi mdi-account"></i> ${author}</li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-7">
                        <img src="${thumbnail}" class="img-fluid rounded shadow" alt="">
                        ...
                        <p class="text-muted mt-4">${postdetail}</p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="widget mb-4 pb-2">
                                    ...
                                    <div id="search2" class="widget-search mt-4 mb-0">
                                        <form role="search" action="blog" method="get" id="searchform" class="searchform">
                                            <div>
                                                <input id="post-title" type="text" class="border rounded" name="postTitle" placeholder="Search Keywords...">
                                                <select class="border rounded mt-2" name="postCategory">
                                                ...
                                                <input type="submit" id="searchsubmit" value="Search" class="mt-2">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="widget mb-4 pb-2">
                                    ...
                                    <div class="tagcloud mt-4">
                                        <% 
                                            // Sử dụng PostDAO để lấy danh sách danh mục
                                            for (String categoryPost : categoryPostList) {
                                        %>
                                        <!-- Mỗi danh mục được hiển thị dưới dạng một thẻ (tag) với liên kết tới BlogServlet -->
                                        <a href="blog?postCategory=<%=categoryPost%>" class="rounded"><%=categoryPost%></a>
                                        <% } %>
                                    </div>
                                </div>
                                <!-- TAG CLOUDS -->
                                ...
                                <!-- SOCIAL -->
                                <!-- Thêm các biểu tượng hoặc liên kết mạng xã hội nếu cần -->
                                <!-- SOCIAL -->
                            </div>
                        </div>
                    </div>
